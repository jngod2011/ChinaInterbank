...
inclusion.edgecov <- c("compound")
inclusion.nodecov <- NULL
inclusion.nodeocov <- c("asst", "lblt")#"nprf", "cdcb", "tfa", "la", "asfa", "bfc", "grp", "nilcb", "scfo"
inclusion.nodeicov <- c("asst", "lblt")#"dbrr", "lnd", "asst", "dlnd", "brr", "lblt"
